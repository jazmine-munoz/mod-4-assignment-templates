...
def material_waste(total_material, material_units, num_jobs, job_consumption):
   ...
   def interest(principal, rate, periods):
    '''
    Calculates the final value of an investment after gaining simple interest over a number of periods.
    ...
    --------
    int
        The final value of the investment, expressed in centavos and rounded down to the nearest centavo.
    '''
